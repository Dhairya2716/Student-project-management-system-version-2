            ...
            <aside className={`${sidebarOpen ? 'w-72' : 'w-20'} relative bg-white/[0.02] border-r border-white/10 flex flex-col transition-all duration-300`}>
                    ...
                    <Link href="/" className="flex items-center gap-3">
                        ...
                        {sidebarOpen && (
                            <div>
                                ...
                                <span className="block text-xs text-emerald-400">Student Portal</span>
                            </div>
                        )}
                    </Link>
                </div>
                ...
                <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
                    {navItems.map((item, i) => (
                        ...
                        >
                            <item.icon className={`w-5 h-5 ${item.active ? 'text-emerald-400' : ''}`} />
                            {sidebarOpen && (
                                <>
                    ...
                    {sidebarOpen && (
                        <div className="flex items-center gap-3 p-4 rounded-2xl bg-white/[0.03] border border-white/10 mb-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-emerald-400">Student</p>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative">
                                ...
                                <input type="text" placeholder="Search..." className="w-64 pl-12 pr-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-emerald-500/50 transition-all" />
                            </div>
