            ...
            <StudentLayout>
                <div className="p-8">
                    <div className="text-center py-16 rounded-2xl bg-white/[0.02] border border-white/10">
                        ...
                        <h2 className="text-xl font-semibold text-white mb-2">Not Assigned to a Group</h2>
                        <p className="text-white/40">You haven't been assigned to a project group yet.</p>
                    </div>
                </div>
            </StudentLayout>
        );
        ...
        <StudentLayout>
            <div className="p-8">
                <div className="mb-8">
                    ...
                    <p className="text-white/50">View your project group and team members</p>
                </div>
                ...
                <div className="rounded-2xl bg-white/[0.02] border border-white/10 p-6 mb-6">
                    <div className="flex items-start justify-between mb-4">
                        <div>
                            ...
                            <p className="text-white/60 mb-3">{group.title}</p>
                            {group.project_type && (
                    ...
                    {group.description && (
                        <p className="text-white/50 mb-4">{group.description}</p>
                    )}
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-6">
                        ...
                        <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className="text-xs text-white/40">Total Meetings</span>
                            </div>
                ...
                {/* Faculty Members */}
                <div className="rounded-2xl bg-white/[0.02] border border-white/10 p-6 mb-6">
                    <h3 className="text-xl font-semibold text-white mb-4">Faculty</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {group.staff_project_group_guide_idTostaff && (
                            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10">
                                ...
                                <p className="font-medium text-white mb-1">{group.staff_project_group_guide_idTostaff.name}</p>
                        ...
                        {group.staff_project_group_convener_idTostaff && (
                            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10">
                                ...
                                <p className="font-medium text-white mb-1">{group.staff_project_group_convener_idTostaff.name}</p>
                                <div className="flex items-center gap-2 text-sm text-white/40 mb-1">
                                    <Mail className="w-3 h-3" />
                        ...
                        {group.staff_project_group_expert_idTostaff && (
                            <div className="p-4 rounded-xl bg-white/[0.02] border border-white/10">
                                ...
                                <p className="font-medium text-white mb-1">{group.staff_project_group_expert_idTostaff.name}</p>
                                <div className="flex items-center gap-2 text-sm text-white/40 mb-1">
                                    <Mail className="w-3 h-3" />
                ...
                <div className="rounded-2xl bg-white/[0.02] border border-white/10 p-6">
                    ...
                    <div className="space-y-3">
                        {group.project_group_member.map((member) => (
                            <div key={member.student.id} className="p-4 rounded-xl bg-white/[0.02] border border-white/10 hover:border-emerald-500/30 transition-all">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-400 flex items-center justify-center">
                                            <span className="text-white font-bold text-lg">{member.student.name.charAt(0)}</span>
                                        </div>
                                        <div>
                                            ...
                                            <p className="text-sm text-white/40">{member.student.enrollment_no}</p>
