        ...
        <div className="p-8 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-white/50 mt-1">Update your account password</p>
                </div>
            </div>
                ...
                <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-8">
                    <div className="flex items-center gap-4 mb-6 pb-6 border-b border-white/10">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-white/50">Keep your account secure with a strong password</p>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-3 pr-12 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-purple-500/50 transition-all"
