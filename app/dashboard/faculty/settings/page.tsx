        ...
        <div className="p-8 space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-white/50 mt-1">Manage your preferences and settings</p>
                </div>
            </div>
                ...
                <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-white/50">Customize how the app looks</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                            <div>
                                ...
                                <p className="text-sm text-white/50">Get notified about upcoming meetings</p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    type="checkbox"
                        ...
                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                            <div>
                                <p className="text-white font-medium">Evaluation Updates</p>
                                <p className="text-sm text-white/50">Get notified about evaluation deadlines</p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    type="checkbox"
