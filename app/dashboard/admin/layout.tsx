...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] flex">
            ...
            {/* Sidebar */}
            <aside className={`${sidebarOpen ? 'w-72' : 'w-20'} fixed left-0 top-0 bottom-0 bg-white/[0.02] border-r border-white/10 flex flex-col transition-all duration-300 z-50`}>
                    ...
                    <Link href="/" className="flex items-center gap-3">
                        ...
                        {sidebarOpen && (
                            <div>
                                ...
                                <span className="block text-xs text-orange-400">Admin Panel</span>
                            </div>
                        )}
                    </Link>
                </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative">
                                ...
                                <input type="text" placeholder="Search..." className="w-64 pl-12 pr-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-orange-500/50 transition-all" />
                            </div>
