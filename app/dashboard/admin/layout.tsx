...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a12] flex transition-colors duration-500">
            ...
            {/* Sidebar */}
            <aside className={`${sidebarOpen ? 'w-72' : 'w-20'} fixed left-0 top-0 bottom-0 glass border-r border-gray-200/80 dark:border-white/[0.06] flex flex-col transition-all duration-300 z-50`}>
                {/* Logo */}
                <div className="p-5 border-b border-gray-200/80 dark:border-white/[0.06]">
                    <Link href="/" className="flex items-center gap-3 group">
                        <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center shadow-lg shadow-orange-500/20 group-hover:shadow-orange-500/40 group-hover:scale-105 transition-all duration-300 shrink-0">
