    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0f] flex transition-colors duration-300">
            ...
            <div className="fixed inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-amber-500/5 rounded-full blur-[150px]"></div>
            </div>

            {/* Sidebar */}
            <aside className={`${sidebarOpen ? 'w-72' : 'w-20'} fixed left-0 top-0 bottom-0 bg-white dark:bg-white/[0.02] border-r border-gray-200 dark:border-white/10 flex flex-col transition-all duration-300 z-50`}>
                    ...
                    <Link href="/" className="flex items-center gap-3">
                        ...
                        {sidebarOpen && (
                            <div>
                                ...
                                <span className="block text-xs text-orange-600 dark:text-orange-400">Admin Panel</span>
                            </div>
                        )}
                    </Link>
                </div>
                        ...
                        return (
                            <Link
                                ...
                                className={`group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 ${isActive
                                    ? 'bg-gradient-to-r from-orange-500/10 to-amber-500/10 border border-orange-500/20 text-orange-600 dark:text-orange-400'
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative">
                                ...
                                <input type="text" placeholder="Search..." className="w-64 pl-12 pr-4 py-2.5 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-white/30 focus:outline-none focus:border-orange-500/50 transition-all" />
                            </div>
